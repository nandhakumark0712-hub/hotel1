    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[550px] md:h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl mx-auto -mt-16 md:-mt-32">
          ...
          <p className="text-lg md:text-2xl text-white/80 mb-12 md:mb-20 max-w-2xl mx-auto font-medium drop-shadow-lg block">
          ...
          <div className="relative max-w-5xl mx-auto w-full group">
            ...
            <div className="absolute -bottom-8 md:-bottom-10 left-1/2 -translate-x-1/2 z-30 w-full max-w-xs px-6">
              ...
              >
                Search <ArrowRight size={24} className="group-hover/btn:translate-x-2 transition-transform" />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div 
              ...
              className="rounded-[2rem] overflow-hidden group cursor-pointer h-72 md:h-96 relative shadow-2xl transition-all duration-500 hover:-translate-y-2 border-none"
            >
              <div className="absolute inset-0 bg-gradient-to-t from-dark/90 via-dark/20 to-transparent z-10" />
              <img 
                src={`${item.img}?auto=format&fit=crop&q=100&w=800`} 
                alt={item.city}
